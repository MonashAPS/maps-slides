...
9. Prove or Disprove the following statements, by coming up with a winning strategy, or giving a game example:
...
7. Figure out the total value of this game of domineering. Determine the first move that should be made by the winning side.
